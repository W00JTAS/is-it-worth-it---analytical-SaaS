...
class FirecrawlProvider:
    ...
    def _build_extract_prompt(
        ...
        return (
            ...
            "Explicitly compare a result's own title against its description: if the title names "
            "one specific variant (a color, size, or model) but the description's price sentence "
            "names a DIFFERENT variant, that price belongs to the different variant named in the "
            "description, not to the variant in the title — skip it, even though the result's URL "
            "and title otherwise look correctly scoped to this product. "
